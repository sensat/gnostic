...
var (
	file_plugins_plugin_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
	file_plugins_plugin_proto_msgTypes  = make([]protoimpl.MessageInfo, 7)
	file_plugins_plugin_proto_goTypes   = []any{
