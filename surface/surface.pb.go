...
var (
	file_surface_surface_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
	file_surface_surface_proto_msgTypes  = make([]protoimpl.MessageInfo, 4)
	file_surface_surface_proto_goTypes   = []any{
